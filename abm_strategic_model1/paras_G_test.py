...
"""
TEMPLATE
for the construction of the parameter dictionary for the creation of a sector network
...
# minimum number of nodes (sectors) between entry and exit. 
# Origin and destination are excluded. Put a negative value for
# no minimum distance.
paras_G['min_dis'] = 1   
