...
file_net = jn(main_dir, 'tests', 'example', 'network.pic')
...
if file_traffic==None:
	...
	density = 80.          				# Relevant for choosing an overall density of flights
	...
	if file_times==None:
		if departure_times=='square_waves':
			...
			Delta_t = 60.*12.      		# Time between the end of a wave and the beginning of the next one.
...
nA = 0.4                        			# percentage of Flights of the first population.
