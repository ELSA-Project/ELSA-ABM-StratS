...
"""
Build a triangular network for new simulations.
"""
...
paras_G['name'] = 'DiskWorld'			# This is just for info too.
if paras_G['file_net_sec'] == None:
	paras_G['N'] = 60 	# Number of sectors.
	paras_G['type_of_net'] = 'T' # 'D' for Delaunay, T for trianguler, E for Erdos-Renyi.
...
if paras_G['file_weights'] == None and not paras_G['generate_weights_from_traffic']:
	paras_G['par_weights'] = (20., 0.0001) # average crossing time for napvoint network in minutes.
	paras_G['typ_weights'] = 'lognormal'

paras_G['min_dis'] = 2      # minimum number of nodes between entry and exit (excluding them).
...
# --------------------System parameters -------------------- #
paras_G['force'] = False	# force overwrite of already existing network (based on name of file).
